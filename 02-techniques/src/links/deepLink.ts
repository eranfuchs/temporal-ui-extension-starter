...
export interface DeepLinkActivity {
    ...
    // the top of src/rowInfo/rowInfo.ts). Here it is different: it is the operator's own
    ...
    // note on DetailActivity.closedAtMs in src/detail/detail.ts for why a per-instance

...
// whose single instance is the const below. Each of them is commented where it
// stands.
...
import { fetchFailureMessage, fetchForListedRun, replyToPage, TAG } from '../page/pageApi';
import { makePacer } from '../page/pacer';
import {
    FRESH_FLOOR_MS,
    readLastEvent,
    readPendingRetry,
...
// ── The pacer ────────────────────────────────────────────────────────────────
//
// The concurrency cap and the 429/503 backoff live in src/page/pacer.ts, with the
// clock and the sleep injected so that "never more than four, even coming out of a
// backoff" is a test rather than a claim. It was inline here, and it was broken here;
// the note at the top of that file says exactly how.
//

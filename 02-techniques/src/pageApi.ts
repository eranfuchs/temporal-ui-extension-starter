...
import { namespaceFromApiUrl, normalizeExecutions, runKey } from './rows';
...
// There is deliberately NO second exported fetch here — nothing that posts to a
// URL its caller chose. This build talks to one server: the Temporal API the page
